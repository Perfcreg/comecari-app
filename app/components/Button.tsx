...
const $viewPresets = {
  ...
  transparentBack: [
    $baseViewStyle,
    { backgroundColor: colors.palette.white, borderWidth: 1, borderColor: "#ACA3A3" },
  ] as StyleProp<ViewStyle>,
...
const $textPresets: Record<Presets, StyleProp<TextStyle>> = {
  ...
  transparentBack: [$baseTextStyle, { color: colors.palette.Black }],
}
...
const $pressedViewPresets: Record<Presets, StyleProp<ViewStyle>> = {
  ...
  transparentBack: { backgroundColor: colors.palette.Black },
}
